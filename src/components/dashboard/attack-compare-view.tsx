            ...
            return (
              ...
              >
                <div className="flex flex-wrap items-center gap-2">
                  <p className="text-sm font-semibold text-neutral-100">{attack.title}</p>
                  <Badge variant="secondary">{attack.category}</Badge>
                </div>
                <p className="mt-2 text-sm text-neutral-400">{attack.description}</p>
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      highlighted
                        ? 'border-red-500/40 bg-red-500/12 text-red-100 shadow-[0_0_0_1px_rgba(248,113,113,0.16)]'
                        : isInputOrOutput
            ...
            <CardContent className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <div className="rounded-lg border border-neutral-800 bg-neutral-950/50 p-3">
                  <p className="text-xs uppercase tracking-[0.16em] text-neutral-500">Safety</p>
                  <p className="mt-1 text-sm font-medium text-neutral-100">
                    {formatSafetyScore(variant.safetyScore)}
                  </p>
                </div>
                <div className="rounded-lg border border-neutral-800 bg-neutral-950/50 p-3">
                  <p className="text-xs uppercase tracking-[0.16em] text-neutral-500">Latency</p>
                  <p className="mt-1 text-sm font-medium text-neutral-100">{variant.latencyMs} ms</p>
                </div>
              </div>

              <p className="text-sm text-neutral-300">
                <span className="text-neutral-500">Reason:</span> {variant.reason}
              </p>
              ...
              <div className="rounded-xl border border-neutral-800 bg-neutral-950/60 p-4 text-sm leading-6 text-neutral-300">
